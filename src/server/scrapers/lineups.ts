...
export async function scrapeLineups(): Promise<Game[]> {
  try {
    ...
    try {
      await db.transaction(async (tx) => {
        ...
        await tx
          ...
          .onConflictDoUpdate({
            target: [pitchersGameInfoTable.pitcherId, pitchersGameInfoTable.gameId],
            set: {
        ...
        await tx
          ...
          .onConflictDoUpdate({
            target: [battersGameInfoTable.batterId, battersGameInfoTable.gameId],
            set: {
